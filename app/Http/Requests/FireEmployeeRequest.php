...
class FireEmployeeRequest extends FormRequest
{
  ...
  public function messages()
  {
    return [
      ...
      'total.required' => 'El monto total es necesario',
      'total.decimal' => 'El monto debe ser un número válido con hasta 2 decimales',
      'percentage.required' => 'El monto porcentaje es necesario',
