...
class StoreAutoReplenishmentConfigRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'is_active'           => ['boolean'],
            'tipo_filtracion'     => ['required', 'in:average,sales,combinado,weighted,stockout_adjusted_rop,stockout_adjusted_rop_plus'],
            ...
            'max_price_increase_percentage' => ['nullable', 'numeric', 'min:0', 'max:500'],
