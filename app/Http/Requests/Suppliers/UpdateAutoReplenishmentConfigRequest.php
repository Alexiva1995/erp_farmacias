...
class UpdateAutoReplenishmentConfigRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tipo_filtracion'     => ['sometimes', 'in:average,sales,combinado,weighted,stockout_adjusted_rop,stockout_adjusted_rop_plus'],
            ...
            'max_price_increase_percentage' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:500'],
