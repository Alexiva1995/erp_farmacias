...
class SocialBenefitRepository implements \App\Contracts\SocialBenefit
{
  /**
  ...
  public function generatePdf(Employee $employee, array $overrides = []): \Barryvdh\DomPDF\PDF
  {
    ...
    if ($savedSettlement && $savedSettlement->total_settlement > 0 && $savedSettlement->social_benefits_amount > 0) {
      ...
      $pdfData = [
        ...
        'company_name' => $employee->id == 15 ? 'Toffle' : null,
        'company_rif' => $employee->id == 15 ? 'V27.108.387-0' : null,
        'company_logo' => $employee->id == 15 ? 'logoToffle.png' : null,
