...
class GeneralSetting extends Model
{
   protected $table = 'general_settings';
    protected $fillable = [
        ...
        'cyclic_inventory_scope',
        'cyclic_inventory_daily_quota',
        'enable_lots',
        'tpv_mode',
    ...
    protected $casts = [
        ...
        'cyclic_inventory_scope' => 'string',
        'cyclic_inventory_daily_quota' => 'integer',
        'enable_lots' => 'boolean',
        'tpv_mode' => 'string',
        'enable_product_types' => 'boolean',
        'enabled_product_types' => 'array',
        'enable_favorites' => 'boolean',
        'enable_bulk_toggle_active' => 'boolean',
