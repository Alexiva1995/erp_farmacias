...
class IaAssistantReportService
{
    ...
    /**
     * Orquesta el reporte grupal con paginación de grupos
     */
    ...
    {
        // Feature 3: sales_average obsoleto (más de 48 horas sin recalcular por el cron nocturno)
        $updatedAt = isset($item->sales_average_updated_at) && $item->sales_average_updated_at
            ...
            : null;
        $item->is_stale_average = !$updatedAt || $updatedAt->lt(now()->subHours(48));
