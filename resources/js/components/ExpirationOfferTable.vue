...
<template>
  <VCard class="rounded-lg border shadow-sm overflow-hidden">
      ...
      >
        <template #no-data>
          <AppEmptyState
            ...
            message="No hay ofertas por vencimiento disponibles con los filtros actuales."
    ...
    <div class="d-block d-md-none pa-2">
      ...
      <div v-if="props.offers.length === 0 && !props.loading" class="text-center py-8 text-disabled">
        No hay ofertas por vencimiento disponibles.
      </div>
