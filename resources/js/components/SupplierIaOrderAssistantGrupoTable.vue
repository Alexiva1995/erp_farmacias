          ...
          <VTable density="compact" class="grupo-table">
            <thead>
              <tr>
                ...
                <th v-if="props.showTrend" class="text-xs font-weight-black text-uppercase text-center" style="inline-size:75px">Trend</th>
            ...
            <tbody>
              ...
              >
                ...
                <td v-if="props.showTrend" class="text-center">
