    ...
    <VCard class="mb-6 rounded-lg border shadow-sm">
      <VCardItem class="py-5">
        <VCardTitle class="text-h5 font-weight-black text-uppercase d-flex align-center gap-2 mb-2">
          <VIcon icon="tabler-users-group" class="text-primary" size="26" />
          Configuración de Vistas de RRHH y Productividad
        </VCardTitle>
        <p class="text-caption text-medium-emphasis mb-6">
          Habilita o deshabilita los módulos y vistas de Recursos Humanos y Productividad en la barra de navegación lateral. Las vistas desmarcadas se ocultarán inmediatamente para todos los usuarios.
        </p>
        ...
        <VRow>
          <VCol v-for="view in availableRrhhViews" :key="view.key" cols="12" sm="6" md="3">
            <VCard
              ...
              :class="enabledRrhhViews.includes(view.key) ? 'border-primary bg-var-theme-background' : 'opacity-60'"
                  ...
                  <div>
                    <div class="d-flex align-center justify-space-between w-100 mb-2">
                      <div class="d-flex align-center">
                        ...
                        <span class="font-weight-black text-body-2" :class="enabledRrhhViews.includes(view.key) ? 'text-high-emphasis' : 'text-disabled'">
                          {{ view.title }}
                        </span>
                      </div>
                      <VSwitch
