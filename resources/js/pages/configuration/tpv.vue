...
const updateSettings = async () => {
  try {
    ...
    await axios.post('/general-settings', updatedData)
      ...
      <VCardItem class="py-5">
        ...
        <VRow>
          <VCol v-for="(currencyData, currency) in tpvPaymentMethods" :key="currency" cols="12" md="4">
            <VCard variant="outlined" class="rounded-lg" :style="{ opacity: currencyData.enabled ? 1 : 0.6 }">
                    ...
                    <div class="d-flex align-center justify-space-between mb-1">
                      <div class="d-flex align-center">
                        ...
                        <VBtn
                          ...
                          :disabled="!currencyData.enabled || !method.enabled"
        ...
        <VRow>
          <VCol v-for="offer in availableOfferOptions" :key="offer.key" cols="12" sm="6" md="3">
            <VCard
              ...
              :class="enabledOfferTypes.includes(offer.key) ? 'border-primary bg-var-theme-background' : 'opacity-60'"
