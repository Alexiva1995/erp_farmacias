...
const hasActiveAdvancedFilters = computed(
  () =>
    selectedLaboratory.value?.length > 0 || selectProducts.value?.length > 0,
);
...
const headers = [
  ...
  {
    title: "Mín. Referencia",
    key: "effective_min_cost",
    align: "end",
    sortable: true,
  },
...
watch(
  [page, itemsPerPage, sortBy, selectedLaboratory, selectProducts, searchQuery],
  () => {
    fetchOpportunities();
  },
  { deep: true },
            ...
            >
              <VCardText class="pa-4">
                <div class="d-flex justify-space-between align-start mb-3">
                  <div class="flex-grow-1">
                    <div class="d-flex align-center gap-1 mb-1">
                      ...
                      <div
                        class="text-subtitle-2 font-weight-black leading-tight truncate"
                      >
                ...
                <VRow dense class="mb-3">
                  <VCol cols="6">
                    <div
                      class="text-caption text-disabled text-uppercase font-weight-bold mb-1"
                    >
                      Costo Actual
                    </div>
                ...
                <div
                  class="d-flex align-center justify-space-between bg-var-theme-background-soft pa-3 rounded-lg border border-dashed"
                >
                  <div
