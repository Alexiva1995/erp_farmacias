...
<div class="title-main">NÓMINA DE PERSONAL</div>

<table class="meta-table">
    <tr>
        <td><strong>Período:</strong> {{ $period }}</td>
        <td><strong>Fecha de Emisión:</strong> {{ \Carbon\Carbon::now()->format('d/m/Y') }}</td>
        <td style="text-align:right;">
            <strong>Tasa BCV:</strong> {{ number_format($exchange_rate, 2, ',', '.') }} Bs./$
        </td>
    </tr>
</table>
...
<div class="footer">
    ...
    Tasa BCV aplicada: {{ number_format($exchange_rate, 2, ',', '.') }} Bs/$.
</div>
