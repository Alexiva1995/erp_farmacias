...
# ==============================================================================
# PUENTE FISCAL PNP CON LOGO FISCAL E IGTF (SCRIPT DE PRUEBAS)
# ==============================================================================
...
# --- WORKER LÓGICA CON LOGO FISCAL E IGTF ---
        ...
        if resp.status_code == 200:
            ...
            if data and 'id' in data:
                ...
                if BRIDGE_MODE == "WEBSIM":
                    ...
                    # 1. Estampar Logo Fiscal en Cabecera (antes o al iniciar factura)
                    try:
                    ...
                    # 2. Abrir Factura Fiscal (Imprime encabezado legal SENIAT, RIF y datos de cliente)
                    ...
                    if apply_igtf:
                        # Protocolo PNP: E|U|<monto_en_centimos> aplica el 3% de IGTF y cierra
...
if __name__ == "__main__":
    ...
    print(f"--- Worker Fiscal DLL con LOGO e IGTF ({BRIDGE_MODE}) ---")
