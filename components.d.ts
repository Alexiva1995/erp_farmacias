...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    copy: typeof import('./resources/js/components/ProductTable copy.vue')['default']
    ...
    ProductGeneralTable: typeof import('./resources/js/components/ProductGeneralTable.vue')['default']
